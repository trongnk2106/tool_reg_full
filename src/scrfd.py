...
class SCRFD():
    ...
    def detect(self, srcimg):
        ...
        for i in indices:
            ...
            thes_box = [xmin, ymin, xamx-xmin, ymax-ymin]
            thres_boxes.append(thes_box)
        ...
        return srcimg, thres_boxes

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--imgpath', type=str, default='selfie.jpg', help='image path')
    parser.add_argument('--onnxmodel', default='weights/scrfd_500m_kps.onnx', type=str, help='onnx model')
